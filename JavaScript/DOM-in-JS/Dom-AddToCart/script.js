...
function createHeader() {
    ...
    header.setAttribute("style", "width:100%;height:75px;background-color:black;");
    header.setAttribute("class", "d-flex justify-content-around");

    var leftHeader = document.createElement("div");
    leftHeader.setAttribute("style", "width:10%;height:100%;padding-left:50px;");
    leftHeader.setAttribute("class", "d-flex align-items-center");


    var logo = document.createElement("img");
    logo.setAttribute("src", "images/e-shop.jpg");
    logo.setAttribute("style", "width:120%;height:90%;border-radius:5%;");

    var searchBar = document.createElement("div");
    searchBar.setAttribute("style", "width:50%;height:100%;");
    searchBar.setAttribute("class", "d-flex justify-content-around");

    var input = document.createElement("input");
    input.setAttribute("placeholder", "Enter to Search a Product");
    input.setAttribute("style", "width:70%;height:60%;font-size:1.5rem;margin-top:2%;padding-left:15px;border:none;margin-left:12%;");

    var SignInOutBtn = document.createElement("div");
    SignInOutBtn.setAttribute("style", "width:25%;height:100%;");
    SignInOutBtn.setAttribute("class", "d-flex justify-content-around align-items-center");


    var SignIn = document.createElement("button");
    SignIn.setAttribute("style", "width:30%;height:60%;font-size:1.6rem;border:none;border-radius:5%; cursor:pointer;");
    ...
    SignUp.setAttribute("style", "width:30%;height:60%;font-size:1.6rem;border:none;border-radius:5%; cursor:pointer;");

    SignIn.innerText = "Sign In";
    SignUp.innerText = "Sign Up";
    SignInOutBtn.appendChild(SignIn);
    SignInOutBtn.appendChild(SignUp);
    header.appendChild(leftHeader);
    leftHeader.appendChild(logo);
    header.appendChild(searchBar);
    header.appendChild(SignInOutBtn);
...
function SignInForm() {
    ...
    var mainDiv = document.getElementById("maindiv");
    mainDiv.setAttribute("class", "d-flex justify-content-center mt-5");

    var form = document.createElement("form");
    form.setAttribute("class", "d-flex flex-column align-items-center  justify-content-center");
    form.setAttribute("style", "background-color: aqua;;border:1px solid black;width:500px;height:300px;border-radius:2.5%;");

    var header = document.createElement("div");
    header.innerText = "Login Form ";
    header.setAttribute("style", "font-size:1.2rem;margin-bottom:20px")

    var email = document.createElement("input");
    email.setAttribute("id", "email");
    email.setAttribute("type", "email");
    email.setAttribute("style", "width:80%;height:35px;border:none;");
    email.setAttribute("placeholder", "Enter email id");

    var password = document.createElement("input");
    email.setAttribute("id", "paasword");
    email.setAttribute("type", "paasword");
    password.setAttribute("style", "width:80%;height:35px;border:none;margin-top:15px;");
    password.setAttribute("placeholder", "Enter Password");

    var btnsection = document.createElement("div");
    btnsection.setAttribute("style", "display:flex;gap:20px;")
    var submitBtn = document.createElement("button");
    submitBtn.setAttribute("class", "btn btn-primary mt-3");
    ...
    newUserBtn.setAttribute("style", "background-color: aqua;border:none;color:red;font-weight:bold;cursor:pointer;margin-top:10px;");
    newUserBtn.innerHTML = "Create Customer";

    form.appendChild(header);
    form.appendChild(email);
    form.appendChild(password);
    btnsection.appendChild(submitBtn);
    btnsection.appendChild(newUserBtn);
    form.appendChild(btnsection);
    mainDiv.appendChild(form);
}
function SignIn(email, password) {
    var userList = JSON.parse(localStorage.getItem("userList"));
    var user = find((userList) => { email == user.email })
    if (user) {
        window.alert("ALready.....Loginned");
    }
    else {
        window.alert("Successfully.....Loginned");
    }
}
...
function createCart() {
    ...
    menudiv.setAttribute("style", "width:100%;height:auto; row-gap:3rem;margin-top:3rem");
    menudiv.setAttribute("class", "d-flex flex-wrap justify-content-around ");
    ...
    for (var ele of data) {
        ...
        btn.setAttribute("class", "btn btn-warning btn btn-primary btn-lg d-flex flex-column mt-auto");
